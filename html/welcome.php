        ...
        <a href="login.html" class="login-icon-container">
          <div class="login-icon">
            <svg width="40" height="40" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <circle cx="20" cy="14" r="7" fill="#111" stroke="#111" stroke-width="2"/>
              <rect x="8" y="26" width="24" height="10" rx="8" fill="#111" stroke="#111" stroke-width="2"/>
            </svg>
          </div>
        </a>
      </div>
    ...
    <div class="user-page" style="max-width: 700px; margin: 48px auto 0 auto; background: #fff; border-radius: 24px; box-shadow: 0 4px 24px rgba(0,0,0,0.12); padding: 40px; font-family: 'Playwrite AU QLD', cursive; position: relative; z-index: 1;">
        <form method="post" action="save_profile.php">
            ...
            <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 32px;">
                <a href="logout.php" class="welcome-glow-btn">Logout</a>
                <button class="welcome-glow-btn" onclick="saveData()">Save Data</button>
            </div>
        </form>
